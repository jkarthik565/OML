...
<div class="container_wrapper"><!--Start Container for the web content-->
    <div class="sidebar_menu"><!--Sidebar-->
    	<h3 class="header_1">OML</h3>
            <ul>
                ...
                $getCat= $connect -> query("SELECT id,catname FROM tblcategory");
                while($rowCat = $getCat-> fetch_array(MYSQLI_ASSOC)){
                ?>
                <li>
                <a href="SubscriberCategory.php?id=<?php echo $rowCat['id']?>"><img src="../Templates/list-style.png" height="8"  width="8"/>&nbsp;<?php echo $rowCat['catname']?></a>
                </li>
                <?php } ?>
            </ul>
    </div><!--End Sidebar--> 
    ...
    <div class="col2"><!--Start second column-->
		...
		$line = 0;
		$page = 'Category.php';
		$dataperpage = $connect -> query("SELECT * FROM tblalbum WHERE albumcat = '$id'");
        ...
        $getAlbum = $connect -> query("SELECT * FROM tblalbum  WHERE albumcat = '$id' ORDER BY id LIMIT $eu,$limit");
...
<div class="footer_wrapper">
    <div class="footer_menu">
        ...
        <br /> <br /> <br />
        <span style="color:#999; font-size:14px; margin-top:10px;">&copy;2012 OML, Inc.</span>
    </div>
</div>
</body>
</html>
