...
<div class="header_menu">
	<div class="menu">
    	<ul>
            ...
            <li><a href="UserAlbum.php">ALBUMS</a></li>
    	</ul>
    </div>
</div>
<!--End Menu-->
...
<div class="container_wrapper">
    ...
    <div class="sidebar_menu">
    	...
    	<ul>
            <li><a href="UserViewAlbums.php"><img src="../Templates/list-style.png" height="8"  width="8"/>&nbsp;View Records</a></li>
        </ul>
    </div> 
    <!--End Sidebar-->
    <!--Start Web Content-->
    <div class="home_content">
     ...
     <td width="120" align="center"><?php echo "<img src=../../Administrator/PHP/upload_images/album/$albumimage width=118 height=118" ?></td>    
                ...
                <tr bgcolor="<?php echo $bgcolor?>">
                	...
                	<td  align="center" class="td_class"><?php echo '<a href=ViewSongs.php?id='.$rowSong['songalbum'].' id=link>'.preg_replace("/\\.[^.\\s]{3,4}$/", "", $rowSong['songfile']).'</a>'; ?></td>
                </tr> 
                <?php } ?> 
          </table>
          <?php 
