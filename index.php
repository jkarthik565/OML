    ...
    <div class="home_content"> <!--Start Web Content-->
        <div class="banner">
          ...
          <div id="apDiv1">
         	...
         	<div id="slideshow">
   				 <div class="active">
      			  <img src="image/image1.jpg" alt="Slideshow Image 1" />
        			
   				 </div>
    
  				  <div>
      				 <img src="image/image3.jpg" alt="Slideshow Image 2" />
      				 
   				 </div>
    
   				 <div>
      				 <img src="image/image4.jpg" alt="Slideshow Image 3" />
      			
   				 </div>
    
    			<div>
       				 <img src="image/image5.jpg" alt="Slideshow Image 4" />
        ...
        <div class="vote_container"> 
        	<form id="vote" name="vote" method="post"  action="vote.php">
            	<div class="header_vote"> 
					...
					$getVote = $connect -> query("SELECT * FROM tblvotes");
					while($row = $getVote-> fetch_array(MYSQLI_ASSOC)){
					?>
...
<div class="img_container"><!--Start image container-->
       ...
       <div id="class_col1">
          <img src="image/image1.jpg" height="165" width="216" id="img"/>
       </div>
       <div id="class_col2"><img src="image/image3.jpg" height="165" width="216" id="img"/></div>
       <div id="class_col3"><img src="image/image4.jpg" height="165" width="216" id="img"/></div>
       <div id="class_col4"><img src="image/image5.jpg" height="165" width="216" id="img"/></div>
...
<div class="col1"><!--Start Bottom web content-->
   	 <div class="header">
            ...
            <?php 
			require_once('Administrator/PHP/connect.php');
			$sql = $connect -> query("SELECT * FROM tblalbum ORDER BY id DESC LIMIT 7");
			while($rowAlbum = $sql -> fetch_array(MYSQLI_ASSOC)){
			?>
   	 ...
   	 <div class="col2">
    	<div class="header">
    		<div id="header_title">OML TOP 6 SONGS &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="Frontend/SongRank.php" id="link" style="font:Verdana, Geneva, sans-serif; font-size:12px;">See Rankings</a></div>
            <table cellpadding="0" cellspacing="0" height="230" id="table"> 
				...
				<?php 
				$getVotes = $connect-> query("SELECT songfile,songpoints FROM tblsongs WHERE songpoints >=1 ORDER BY songpoints DESC LIMIT 6") or die (mysqli_error());
				while($row = $getVotes -> fetch_array(MYSQLI_ASSOC)){
				$r = rand(128,255);
				$g = rand(128,255);
				$b = rand(128,255);
     ...
     <div class="header">
    	...
    	<div class="header">
            ...
            <?php 
			$sql = $connect -> query("SELECT tblsongs.id,tblsongs.songfile,tblalbum.albumimage,tblalbum.albumname,tblsongs.songsinger FROM tblsongs,tblalbum WHERE tblsongs.songalbum = tblalbum.id AND songcat = 'TELUGU' ORDER BY id DESC LIMIT 7");
			while($rowAlbum = $sql-> fetch_array(MYSQLI_ASSOC)){
			?>
            <div class="album_holder">
            	<div class="content_holder">
