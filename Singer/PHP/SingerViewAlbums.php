...
<div class="container_wrapper">
    ...
    <div class="sidebar_menu">
    	...
    	<ul>
        	<li><a href="SingerAlbum.php"><img src="../Templates/list-style.png" height="8"  width="8"/>&nbsp;Add New Album</a></li>
            <li><a href="SingerViewAlbums.php"><img src="../Templates/list-style.png" height="8"  width="8"/>&nbsp;View Records</a></li> 
        </ul>
    </div> 
    <!--End Sidebar-->
    <!--Start Web Content-->
        	...
        	<div class="form">
            	<table width="650" border="0" cellpadding="1" cellspacing="0" bgcolor="">
                    ...
                    <tr align="center" bgcolor="<?php echo $bgcolor?>">
                        ...
                        <a href="SingerViewSongs1.php?id=<?php echo $rowCat['id']?>" class="link">View Songs</a>&nbsp;|&nbsp;
                        <a href="SingerSong.php?id=<?php echo $rowCat['id']?>" class="link">Add Song</a>&nbsp;|&nbsp;
                        <a href="SingerEditAlbum.php?id=<?php echo $rowCat['id']?>" class="link">Edit</a>&nbsp;|&nbsp;
						<a href="SingerMakePubAlbum.php?id=<?php echo $rowCat['id']?>" class="link" onclick="return confirm('Your request will be processed in 24 hours');">Make Public</a>&nbsp;|&nbsp;
                        <a href="SingerDeleteAlbum.php?id=<?php echo $rowCat['id']?>" class="link" onclick="return confirm('Do you want to delete this?');">Delete</a></td>
                    </tr>
