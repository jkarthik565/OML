...
<div class="container_wrapper">
    ...
    <div class="sidebar_menu">
    	...
    	<ul>
        	<li><a href="SingerAlbum.php"><img src="../Templates/list-style.png" height="8"  width="8"/>&nbsp;Add Album</a></li>
    ...
    <div class="home_content">
		...
		<div class="error"></div>
			<form id="form" method="post" name="form" enctype="multipart/form-data" action="SingerAddSong.php" target="uploadframe">	
                <div>
                ...
                <div>
                    ...
                    <input type="button" value="Back" id="button2" onClick="window.location.href='SingerViewAlbums.php'"/>
                </div>
            </form>
    </div>
     <!--End Web Content-->
