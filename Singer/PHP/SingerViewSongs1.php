...
<div class="container_wrapper">
    ...
    <div class="home_content">
    	<h2 class="header">View Album Songs</h2>
				...
				$id = $_REQUEST['id'];
				$getRows = $connect -> query("SELECT * FROM tblsongs WHERE songalbum = '$id'");
     ...
     <td width="120" align="center"><?php echo "<img src=../../Administrator/PHP/upload_images/album/$albumimage width=118 height=118" ?></td>    
				...
				$getSong = $connect -> query("SELECT songalbum,songfile FROM tblsongs WHERE tblsongs.songalbum = '$id'");
                ...
                <tr bgcolor="<?php echo $bgcolor?>">
                	...
                	<td  align="center" class="td_class"><?php echo '<a href=ViewSongs1.php?id='.$rowSong['songalbum'].' id=link>'.preg_replace("/\\.[^.\\s]{3,4}$/", "", $rowSong['songfile']).'</a>'; ?></td>
                </tr> 
                <?php } ?> 
          </table>
          <?php 
