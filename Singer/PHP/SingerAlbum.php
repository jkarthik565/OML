    ...
    <div class="home_content">
    	<h2 class="header">Albums</h2>	
			...
			<div class="error"></div>
            	...
            	<form  method="post" id="form" enctype="multipart/form-data" action="SingerAddAlbum.php" target="uploadframe">
                    <div>
                    ...
                    <div>
                        ...
                        <input type="file" name="txtimage" id="txtimage" onchange="uploadFile()"/><br>
