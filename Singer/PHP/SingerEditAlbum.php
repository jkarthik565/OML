    ...
    <div class="home_content">
    	<h2 class="header">Albums</h2>	
        	<div class="form">
            	...
            	<form name="category" method="post" id="form" enctype="multipart/form-data" action="SingerUpdateAlbum.php" target="uploadframe">
                    <div>
                    ...
                    <div>
                        ...
                        <input type="button" id="button2" onclick="window.location.href='SingerViewAlbums.php'" value="Back" />
                    </div>
