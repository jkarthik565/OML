    	...
    	<h2 class="header">Album Record Section</h2>	
        	<div class="form">
            	<table width="650" border="0" cellpadding="1" cellspacing="0" bgcolor="">
                	<tr>
                    	<th class="table">ID</th><th class="table">Album</th><th class="table">Singer</th><th class="table">Writer</th><th class="table">User</th><th class="table">Image</th><th class="table">Action</th>
                    </tr>
                    <?php
						require_once('connect.php');
						error_reporting(E_ERROR);
						$line = 0;
						$page = 'userrequests.php';
						...
						$sql = $connect -> query("SELECT tblalbum.id,tblcategory.catname,tblalbum.albumname,tblalbum.albumsinger,tblalbum.albumwriter,tblalbum.albumimage,tblalbum.username,tblalbum.temp_id FROM tempalbum tblalbum,tblcategory WHERE tblalbum.albumcat = tblcategory.id ORDER BY id ASC LIMIT $eu, $limit");
                    ...
                    <tr align="center" bgcolor="<?php echo $bgcolor?>">
						...
						<td align="center"><?php echo $rowCat['username'] ?></td>
                        <td align="center" width="60"><?php echo "<img src=upload_images/album/$rowCat[albumimage] width=50 height=40"?></td>
                        <td align="center" width="220">
                        
                        <a href="Makepublic.php?id=<?php echo $rowCat['temp_id']?>" class="link" onclick="return confirm('Are you sure ?');">Make Public</a>&nbsp | &nbsp;
						<a href="UserViewAlbum.php?id=<?php echo $rowCat['temp_id']?>" class="link">View Songs</a>&nbsp;
