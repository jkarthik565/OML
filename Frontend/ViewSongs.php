...
$id = $_REQUEST['id'];
$getAlbumImage = $connect -> query("SELECT * FROM tblalbum WHERE id = '$id'");
...
<link rel="stylesheet" type="text/css" href="Javascript/skins/jplayer-blue-monday/jplayer.blue.monday2.css" />
<script type="text/javascript"  src="Javascript/jquery-1.6.2.min.js"></script>
<script type="text/javascript" src="Javascript/js/jquery.jplayer.min.js"></script>
<script type="text/javascript" src="Javascript/js/jquery.jplayer.min2.js"></script>
